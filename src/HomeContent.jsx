...
{/* Footer */}
      <footer className="bg-black py-12 border-t border-white/10 text-white relative z-10">
        <div className="container mx-auto px-6">
          ...
          {/* Hauptbereich: Links & Logo */}
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-20 mb-8">
            
            <Link to="/impressum" className="text-sm uppercase tracking-widest text-slate-400 hover:text-[#e63946] transition-colors font-medium">
              Impressum
            </Link>
            ...
            <Link to="/" className="group block">
              <img 
                src="/logo.svg" 
                alt="Breisgau Automobile" 
                className="h-10 md:h-12 w-auto object-contain opacity-80 group-hover:opacity-100 group-hover:scale-105 transition-all duration-300" 
              />
            </Link>

            <Link to="/datenschutz" className="text-sm uppercase tracking-widest text-slate-400 hover:text-[#e63946] transition-colors font-medium">
              Datenschutz
            </Link>
          ...
          <div className="text-center border-t border-white/5 pt-8">
            <p className="text-xs text-slate-600">
              &copy; {new Date().getFullYear()} Breisgau Automobile. Alle Rechte vorbehalten.
            </p>
          </div>
        </div>
      </footer>
